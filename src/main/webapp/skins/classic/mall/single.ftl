		...
		<div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<!-- //FlexSlider-->
					<ul class="slides">
						<li data-thumb="${staticServePath}/js/mall/images/d2.jpg">
							<div class="thumb-image"> <img src="${staticServePath}/js/mall/images/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="${staticServePath}/js/mall/images/d1.jpg">
							<div class="thumb-image"> <img src="${staticServePath}/js/mall/images/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="${staticServePath}/js/mall/images/d3.jpg">
							<div class="thumb-image"> <img src="${staticServePath}/js/mall/images/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="${staticServePath}/js/mall/images/d4.jpg">
							<div class="thumb-image"> <img src="${staticServePath}/js/mall/images/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
					</ul>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="${staticServePath}/js/mall/images/men3.jpg" alt=" " class="img-responsive">
										</div>
