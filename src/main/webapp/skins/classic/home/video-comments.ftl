...
<div class="tabs-sub fn-clear">
    <a pjax-title="${videoLabel} - ${user.userName} - ${symphonyLabel}" href="${servePath}/member/${user.userName}/videos" <#if type == "videos">class="current"</#if>>${videoLabel}</a>
    <a pjax-title="${cmtLabel} - ${user.userName} - ${symphonyLabel}" href="${servePath}/member/${user.userName}/videos/comments"<#if type == "videoComments"> class="current"</#if>>${cmtLabel}<#if type == "videoComments"> &nbsp;<span class="count">${paginationRecordCount?c}</span></#if></a>
