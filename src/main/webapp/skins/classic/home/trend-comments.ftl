...
<div class="tabs-sub fn-clear">
    <a pjax-title="${videoLabel} - ${user.userName} - ${symphonyLabel}" href="${servePath}/member/${user.userName}/trends" <#if type == "trends">class="current"</#if>>${trendsLabel}</a>
    <a pjax-title="${trendAddCommentLabel} - ${user.userName} - ${symphonyLabel}" href="${servePath}/member/${user.userName}/trends/comments"<#if type == "trendComments"> class="current"</#if>>${trendAddCommentLabel}<#if type == "videoComments"> &nbsp;<span class="count">${paginationRecordCount?c}</span></#if></a>
