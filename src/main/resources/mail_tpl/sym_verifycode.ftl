                        ...
                        <tbody>
                            ...
                            <tr style="border-collapse:collapse">
                                <td width="640" align="center" bgcolor="#FFFFFF" style="border-collapse:collapse;font-family:Helvetica,Arial,sans-serif">
                                    <a href="${servePath}" target="_blank" style="line-height: 100%;color: white;font-size: 22;margin-top: 25px;font-family: Courier;text-decoration:none">
                                        <#--<img height="140" width="640" src="${staticServePath}/images/mail/verify-banner1.png" alt="搬砖猫">-->
                                            brickcat.club
                                    </a>
                                </td>
                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="border-collapse:collapse">
                                                ...
                                                <td width="180" valign="top" style="border-collapse:collapse;font-family:Helvetica,Arial,sans-serif">
                                                    <p align="right" style="font-size:12px;line-height:18px;color:#999;margin-top:0px;margin-bottom:15px;white-space:normal"><span>© 2016 <a href="${servePath}" style="color:#4183c4;font-weight:bold;text-decoration:none" target="_blank">hacpai.com</a> <span style="color:#333;">黑客与肌霸</span></span><br style="line-height:100%"><span style="font-size:12px;color:#ccc;">Feel easy about trust.</span></p>
                                                </td>
                                                <td width="30" style="border-collapse:collapse;font-family:Helvetica,Arial,sans-serif"></td>
                                            </tr>
                                            <tr style="border-collapse:collapse">
